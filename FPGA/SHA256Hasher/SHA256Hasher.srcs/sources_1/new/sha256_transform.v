...
*
* Date: 24.04.2015
* Modified by: Goshik (goshik92@gmail.com)
* Company: MR Technologies
* Description: Output registering of module sha256_transform was moved to SHA256_Controller
*
*/
...
module sha256_digester (clk, k, rx_w, rx_state, tx_w, tx_state);
	...
	SHA256_e0	e0_blk	(rx_state[`IDX(0)], e0_w);
	SHA256_e1	e1_blk	(rx_state[`IDX(4)], e1_w);
	SHA256_ch	ch_blk	(rx_state[`IDX(4)], rx_state[`IDX(5)], rx_state[`IDX(6)], ch_w);
	SHA256_maj	maj_blk	(rx_state[`IDX(0)], rx_state[`IDX(1)], rx_state[`IDX(2)], maj_w);
	SHA256_s0	s0_blk	(rx_w[63:32], s0_w);
	SHA256_s1	s1_blk	(rx_w[479:448], s1_w);
